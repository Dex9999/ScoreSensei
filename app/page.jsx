  ...
  useEffect(() => {
    async function load() {
      ...
      document.querySelectorAll("img").forEach((element) => {
        if (element.id < level && element.id != "0") {
          element.src = "/public/completebutton.png";
        } else if (element.id > level && element.id != "0") {
          element.src = "/public/redbutton.png";
        }
      });
    }
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div id="home">
          ...
          <a id="1" href="#level1" onClick={() => startLevel(1)}>
            <img className="button" src="/public/playbutton.png" width="150" height="150" id="1" />
          </a>
          <h1 id="1">The Basics</h1>
          <br />
          <h1>Level Two</h1>
          <a id="2" href="#level2" onClick={() => startLevel(2)}>
            <img className="button" src="/public/playbutton.png" width="150" height="150" id="2" />
          </a>
          <h1 id="2">New Notes</h1>
          <br />
          <h1>Level Three</h1>
          <a id="3" href="#level3" onClick={() => startLevel(3)}>
            <img className="button" src="/public/playbutton.png" width="150" height="150" id="3" />
          </a>
